...
- [Overpass API](https://overpass-api.de/) for OSM geometry
...
src/osm.js            Nominatim geocoding, Overpass queries, tag classification
src/render.js         projection and SVG drawing
